 ...
 * @author han
 */
public class ActivityGoalSettingDistance extends Activity {
    ...
    public void saveGoal(View view) {
        ...
        UserGoal newGoal = CurrentGoal.makeGoal(disValue, UserGoal.GOAL_IS_VALID, goalHelper.getGoalName(), goalHelper.getGoalOrder(), Values.MetricMode, 0, UserGoal.GOAL_TYPE_DISTANCE);
    ...
    public void useGoal(View view) {
        ...
        if (!goalHelper.isGoalAlreadySaved()) {
            ...
            UserGoal newGoal = CurrentGoal.makeGoal(disValue, UserGoal.GOAL_IS_NOT_VALID, goalHelper.getGoalName(), goalHelper.getGoalOrder(), Values.MetricMode, 0, UserGoal.GOAL_TYPE_DISTANCE);
            goalHelper.setGoalData(newGoal);
        }
