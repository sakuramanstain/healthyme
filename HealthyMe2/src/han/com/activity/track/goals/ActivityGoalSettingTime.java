 ...
 * @author han
 */
public class ActivityGoalSettingTime extends Activity implements InterfaceClockSetterValue {
    ...
    public void saveGoal(View view) {
        ...
        UserGoal newGoal = CurrentGoal.makeGoal(timeValue, UserGoal.GOAL_IS_VALID, goalHelper.getGoalName(), goalHelper.getGoalOrder(), "min", 0, UserGoal.GOAL_TYPE_TIME);
    ...
    public void useGoal(View view) {
        ...
        if (!goalHelper.isGoalAlreadySaved()) {
            ...
            UserGoal newGoal = CurrentGoal.makeGoal(timeValue, UserGoal.GOAL_IS_NOT_VALID, goalHelper.getGoalName(), goalHelper.getGoalOrder(), "min", 0, UserGoal.GOAL_TYPE_TIME);
            goalHelper.setGoalData(newGoal);
        }
