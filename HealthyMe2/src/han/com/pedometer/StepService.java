...
public class StepService extends Service {
    ...
    public void onCreate() {
        ...
        SingletonListenerStep.getInstance().setPedometerSettings(mPedometerSettings);
        ...
        mStepDetector.addStepListener(SingletonListenerStep.getInstance());
    ...
    private void showNotification() {
        CharSequence text = "HealthyMe";

        Notification notification = new Notification(R.drawable.ic_notification_pedometer, null,
